...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
        \draw[black] (0, 0) -- (4, 0) -- (2, 3.46) -- cycle;
        \draw[black] (1.0, 0.5) -- (2.0, 0.3) -- (2.5, 2.0) -- (2.0, 2.5) -- cycle;
        \filldraw[black] (1.0, 0.5) circle (1pt);
        \filldraw[black] (2.0, 0.3) circle (1pt);
        \filldraw[black] (2.5, 2.0) circle (1pt);
        \filldraw[black] (2.0, 2.5) circle (1pt);
    \end{tikzpicture}
    \caption{A convex quadrilateral inside a equilateral triangle $L$.}
\end{figure}
\end{comment}
...
\begin{figure}[ht]
    \begin{minipage}[b]{.5\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \filldraw[black] (2.0, 2.5) circle (1pt);
        \end{tikzpicture}        
        %\subcaption{Convex quadrilateral.}
    \end{minipage}
    \hspace{0.1cm}
    \begin{minipage}[b]{.4\textwidth}
        ...
        \end{tikzpicture}       
        %\subcaption{Re-entrant quadrilateral.}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \end{tikzpicture}
    \caption{Sampling a random point in a triangle.}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{images/equilateral_triangle.pdf}
    \caption{Equilateral triangle generated with $N = 10000$ points.}
\end{figure}
...
\begin{figure}[ht!]
    \begin{minipage}[b]{.5\textwidth}
        \centering
        \begin{tikzpicture}
            \draw[black] (2.0, 3.0) -- (4.0, 1.0) -- (5.0, 3.0) -- (4.0, 4.0) -- cycle;
            \filldraw[black] (2.0, 3.0) circle (1pt);
            \filldraw[black] (4.0, 1.0) circle (1pt);
            \filldraw[black] (5.0, 3.0) circle (1pt);
            \filldraw[black] (4.0, 4.0) circle (1pt);
        \end{tikzpicture}        
        %\subcaption{Convex quadrilateral.}
    \end{minipage}
    \hspace{0.1cm}
    \begin{minipage}[b]{.4\textwidth}
        \centering
        \begin{tikzpicture}
            \draw[black] (0.0, 0.0) -- (2.0, 3.0) -- (4.0, 0.0) -- (0.0, 0.0) -- cycle;
            \draw[black] (0.0, 0.0) -- (2.0, 1.0);
            \draw[black] (2.0, 1.0) -- (2.0, 3.0);
            \draw[black] (2.0, 1.0) -- (4.0, 0.0);
            \filldraw[black] (0.0, 0.0) circle (1pt);
            \filldraw[black] (2.0, 3.0) circle (1pt);
            \filldraw[black] (4.0, 0.0) circle (1pt);
            \filldraw[black] (2.0, 1.0) circle (1pt);
        \end{tikzpicture}       
        %\subcaption{Re-entrant quadrilateral.}
    \end{minipage}
    \caption{Convex and degenerate cases.}
\end{figure}
\end{comment}
